[Feddas](https://github.com/feddas) Open SCAD models. [Open SCAD](https://github.com/openscad/openscad/?tab=readme-ov-file#getting-started) is a free tool for creating 3D print models using a scripting language.
...
[Wire Shelf Label](WireShelfLabel.scad) | [Thingiverse](https://www.thingiverse.com/thing:7193444) | A paper label holder that snaps into the side of a wire shelf.

# Downloadable files

Compiled 3D models are exported as *.stl files and listed under Assets [in this repositories releases](https://github.com/Feddas/OpenScad/releases).
